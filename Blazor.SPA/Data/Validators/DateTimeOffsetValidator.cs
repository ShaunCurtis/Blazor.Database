...
namespace Blazor.SPA.Data
{
    ...
    {
        public DateTimeOffsetValidator(DateTimeOffset value, string fieldName, object model, ValidationMessageStore validationMessageStore, string message) : base(value, fieldName, model, validationMessageStore, message) { }
